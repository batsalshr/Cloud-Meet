	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/availability/month/_server.ts.js'))
			},
			{
				id: "/api/bookings",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/bookings/cancel/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/bookings/propose-reschedule/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/bookings/reschedule/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/calendars/google/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cron/send-reminders/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/email-templates/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/event-type/_slug_/_server.ts.js'))
			},
			{
				id: "/api/profile",
				pattern: /^\/api\/profile\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/auth/outlook/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/auth/outlook/callback/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/auth/outlook/disconnect/_server.ts.js'))
			},
			{
				id: "/cancel/[id]",
				pattern: /^\/cancel\/([^/]+?)\/?$/,
