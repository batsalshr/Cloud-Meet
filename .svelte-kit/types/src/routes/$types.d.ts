...
type LayoutRouteId = RouteId | "/" | "/[slug]" | "/cancel/[id]" | "/dashboard" | "/dashboard/availability" | "/dashboard/calendars" | "/dashboard/emails" | "/dashboard/event-types/[id]" | "/dashboard/event-types/new" | "/reschedule/[id]" | "/reschedule-response/[token]" | null
type LayoutParams = RouteParams & { slug?: string; id?: string; token?: string }
